...
export default function App() {
  ...
  // Routing rules: Bypass login for Landing Page and Customer Booking View.
  // Explicitly check for dashboard or login hash routes.
  const isDashboardRoute = currentHash.startsWith('#/dashboard') || (currentHash !== '' && currentHash !== '#/' && currentHash !== '#/book' && currentHash !== '#/login');
  ...
  if (isLoginRoute || isDashboardRoute) {
    ...
    // Default fallback (root `/` or default hash `#/`) is the landing page
